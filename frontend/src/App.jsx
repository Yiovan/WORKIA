...
import {
  UploadCloud, Briefcase, MapPin, DollarSign, ArrowLeft,
  Building2, Sparkles, Zap, Target, Globe, Shield, ChevronDown,
  Star, CheckCircle, ArrowRight, Brain, Search, FileText
} from 'lucide-react'
import './App.css'
    ...
    <section className="hero">
      ...
      <div className="hero-actions">
        <button className="btn-primary" onClick={onCTAClick}>
          <Sparkles size={18} /> Analizar mi CV gratis
        </button>
  ...
  return (
    <div className="cta-section">
      <div className="cta-card">
        ...
        <button className="btn-primary" onClick={onCTAClick}>
          <Sparkles size={18} /> Analizar mi CV ahora
        </button>
      </div>
    </div>
  )
